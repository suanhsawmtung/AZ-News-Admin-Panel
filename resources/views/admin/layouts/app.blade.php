    ...
    <div class="sidebar">
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{ route('profile#myProfilePage') }}" class="nav-link">
          ...
          <li class="nav-item">
            <a href="{{ route('news#newsListPage') }}" class="nav-link">
         ...
         <li class="nav-item">
            <a href="{{ route('account#accountListPage') }}" class="nav-link">
          ...
          <li class="nav-item">
            <form action="{{ route('logout') }}" class="nav-link" method="POST">
              ...
              <p>
                <input type="submit" value="Logout" class="sidebar-dark-primary text-muted border-0">
              </p>
            </form>
          </li>
        </ul>
